...
import Day15_Arrays.C06_ArrayElementEklemeMetodu;
...
public class c01_ArrayList {
         ...
         */
            ...
            int[] arr ={3,4};
            arr = C06_ArrayElementEklemeMetodu.YeniElementEkle(arr,5);
            System.out.println(Arrays.toString(arr)); // [3, 4, 5]

            arr = C06_ArrayElementEklemeMetodu.YeniElementEkle(arr,15);
